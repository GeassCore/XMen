...
static void rst_task2_func(void *arg)
{
    ...
    {
	    RST_PRINT_TIME(
		"R-Rhealstone: average_semaphore_shuffle_time, in cpu cycles",
		telapsed, /* Total time of all benchmarks */
		(RST_BENCHMARKS_COUNT
		 * 2),		 /* Total number of times deadlock broken*/
...
{
	RST_PRINT("RST: semaphore shuffle benchmark\r\n");
